...
SafeAddString(FISHERMANSFRIEND_LAKE_FISHING_HOLE, "Lacustre",	0)
SafeAddString(FISHERMANSFRIEND_SALT_FISHING_HOLE, "Trou de pêche  d'eau de mer", 	0)
SafeAddString(FISHERMANSFRIEND_MYST_FISHING_HOLE, "Mystique",0)
SafeAddString(FISHERMANSFRIEND_FOUL_FISHING_HOLE, "Trou de pêche sale", 0)
SafeAddString(FISHERMANSFRIEND_OILY_FISHING_HOLE, "Huileux", 	0)
SafeAddString(FISHERMANSFRIEND_RIVR_FISHING_HOLE, "Rivière", 0)
